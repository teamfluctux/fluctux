...
//   return (
//     <div
//       className={`px-2 py-0.5 text-text-color_2 overflow-hidden text-workspace_2 transition-colors hover:bg-(--surface-indigo-bg) rounded-tiny peer-checked:bg-(--surface-indigo-bg)! peer-checked:text-(--surface-indigo-fg)! peer-checked:shadow-[inset_0px_0px_1px_1px_var(--surface-indigo-border)] ${className}`}
//     >
//       {Icon && <Icon size={16} />}
//       <span>{label}</span>
//     </div>
