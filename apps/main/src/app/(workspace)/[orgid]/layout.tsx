...
import { RndWindows } from "@/components/core/workspace/rnd-window";
    ...
    loading: () => (
      ...
      >
        <div className="w-full rounded-tiny border border-border-color_2 backdrop-blur-lg fx-flex-cl p-1 gap-1 ">
          <Skeleton height={50} borderRadius={"5px"} />
        </div>
      </div>
    ),
  }
    ...
    <>
      ...
      >
        ...
        {/* ==========================================================================
                                      Content
      ========================================================================== */}
        <div className={cn("w-full h-screen bg-background-color_2 relative ")}>
