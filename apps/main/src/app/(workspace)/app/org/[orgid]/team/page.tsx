      ...
      <div className="w-full h-[300px] bg-gradient-to-t relative from-[var(--background)] to-[var(--gradient-team-header)] fx-flex-center">
        ...
        <div className="max-w-[1100px] w-full fx-flex-between-ic">
          <div>
            ...
            <p className="text-[20px] fx-label-color">
              Build your dream team, collaborate, and achieve more together!
            </p>
          </div>
        ...
        <div className="team-nav max-w-[1100px] w-full h-[50px] fx-flex-between-ic">
          <nav className="w-full fx-flex-cl">
            <ul className="fx-flex-cl gap-2">
              <Link href={""}>
                <li className="border p-3 h-[40px] fx-flex-center fx-rounded font-medium fx-label-color fx-secondary-bg fx-border-color">
                  All
                </li>
              </Link>
              <Link href={""}>
        ...
        <div className="max-w-[1100px] w-full team-container">
          {Array.from({ length: 5 }).map((item, i) => {
            return (
              <div
                key={i}
                className="team-card w-full h-fit rounded-[8px] border fx-border-color fx-primary-bg overflow-hidden"
              >
                  ...
                  <div>
                    <div>
                      <Image
                        ...
                        width={500}
                        height={500}
                        className="w-full h-[100px] object-cover object-top border fx-border-color"
                        alt="cover-image"
                      />
                      ...
                      <div className="fx-flex-cl gap-3 p-5 pb-0 pt-0 relative">
                        <Image
                          ...
                          height={100}
                          alt="team-image"
                          className="w-[60px] absolute bottom-[0px] h-[60px] object-cover object-center border fx-border-color rounded-[8px]"
                        />
                        <h2 className="text-[20px] font-medium one-line-ellipsis translate-x-[70px] translate-y-[3px]">
                          Ni Mahins Team
                        </h2>
                      </div>
                    </div>

                    <p className="two-line-ellipsis p-5 pt-0 text-[15px] fx-label-color mt-3 h-[45px]">
                      Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                      Sapiente enim itaque sunt quod, corrupti vel praesentium
                      architecto corporis rerum voluptatem magnam voluptas minus
                      ullam deserunt ratione at iste! Accusamus veritatis et
                      distinctio dolor quo accusantium dolore tempora similique
                      voluptas saepe? Possimus animi officia tempora non saepe
                      consequuntur quia hic exercitationem.
                    </p>
                  </div>
                  <div className="fx-flex-between-ic p-5 border-t fx-border-color mt-3 pt-3 pb-0">
                    <div className="fx-flex-cl">
                      <FxOverlayImages />
                      <span className="text-[25px] fx-label-color font-light">
                        +
                      </span>
