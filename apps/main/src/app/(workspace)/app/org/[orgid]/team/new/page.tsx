"use client";
import { useImagePreview, useShowSuggestions } from "@fluctux/hooks";
import {
  ArrowLeftSolidIcon,
  DeleteIcon,
  ImageIcon,
...
export default function NewTeamPage() {
  ...
  const { imagePreview, handleRemoveImage, handleImageChange } =
    useImagePreview();
                ...
                {imagePreview ? (
                  <>
                    ...
                    <FxButton
                      ...
                      variant="secondary"
                      className="absolute bottom-2 right-2 w-[30px] h-[30px] fx-flex-center"
                      radius="circle"
                    >
          ...
          <div className="mt-7">
            <FxPopupRadio
              ...
              classNames={{
                ...
                layout: "w-[250px]",
                label:
                  "rounded-[5px] w-full h-[60px] pl-3 pr-3 hover:fx-third-bg",
