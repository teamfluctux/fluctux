    ...
    <Card className="pt-0 !bg-transparent">
      <CardHeader className="flex items-center gap-2 space-y-0 border-b border-border-color_1 py-5 sm:flex-row">
        ...
        <Select value={timeRange} onValueChange={setTimeRange}>
          ...
          <SelectContent className="rounded !z-[99999999999999999]">
            <SelectItem value="90d" className="rounded-tiny">
              Last 3 months
            </SelectItem>
            <SelectItem value="30d" className="rounded-tiny">
              Last 30 days
            </SelectItem>
            <SelectItem value="7d" className="rounded-tiny">
              Last 7 days
            </SelectItem>
          </SelectContent>
        </Select>
