    ...
    <>
      <div className="h-[calc(100%-107px)] w-full overflow-y-auto custom-scrollbar">
        <div className="h-[1200px]">
          <ul className="p-2 ">
            <Link href="#">
              <li className="text-workspace_2 font-medium text-text-color_4 group fx-flex-cl gap-2 px-2 py-1 hover:bg-background-color_900C rounded-tiny hover:text-text-color_1">
