...
- ✅ Translates to standard like [Babel](https://hello.com).
...
const myElement = (
  <p>I am a paragraph.</p> // [!code ++]
  <p>I am a paragraph too.</p> // [!code --]
);
```
...
const myElement = (
  //[!code highlight:1] 
  <> 
    <p>I am a paragraph djklg lsjlkj lksdg lkdjglk sdlk glk glksd gksdjlk glksd glksd gjksdogj sdlkg sdlkg lksdgjlksdg dlg sdokg lk.</p> //[!code highlight] 
    <p>I am a paragraph too. sjglksd glsdg ksdlgjksdlgjsdlkgjlk</p>
  </> // [!code highlight]
);
```
