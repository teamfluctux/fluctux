  ...
  return (
    <div className="w-full">
      ...
      <div className="absolute h-[800px] w-full top-0 left-0 overflow-hidden -z-10">
        ...
        <div className="absolute bottom-0 left-0 w-full bg-gradient-to-b from-transparent to-background-color_950C h-[300px]">
      ...
      <div className="fx-layout-max-1200 mx-auto h-[1000px]">
        <div className="w-full flex flex-col justify-center items-center mt-52">
          ...
          <p className="text-[18px] font-medium text-text-color_2 text-center max-w-[800px] mt-5 leading-[1.5rem]">
            ...
            management and social collaboration platform that works the way you
            do. Unite your team and effortlessly manage projects across any
            industry
          </p>
        </div>
      </div>
