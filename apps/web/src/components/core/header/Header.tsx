...
export const Header = () => {
  return (
    <header className="w-full h-[64px] border-b border-border-color_1 fixed backdrop-blur-3xl top-0 left-0 z-50 main-header fx-secondary-bg fx-flex-center pl-3 pr-3">
