...
const DynamicDocSidebar = dynamic<DocSidebarPropsType>(
  () => import("./doc-sidebar"),
  {
    ...
    loading: () => (
      <aside
        className={`w-[250px] h-screen sticky top-0 bg-background-color_950C flex-shrink-0 doc-aside-nav doc-aside-nav-loader transition-all duration-150 ease-out`}
      >
