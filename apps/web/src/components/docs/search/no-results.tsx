  ...
  return (
    <div className="p-3 w-full h-[calc(100%-50px)] fx-flex-center flex-col">
      <div className="fx-flex-center gap-2 max-w-[500px] w-full ">
        <SadIcon width={24} height={24} className="shrink-0" />
        <p className="text-read_20 font-medium text-text-color_2 one-line-ellipsis">
          No results for <q>{indexUiState.query}</q>.
        </p>
      </div>

      <div className="max-w-[500px] w-full mt-10">
        <p className="text-workspace_2 text-text-color_3 font-medium">
          Navigate to:
        </p>
        <ul className=" w-full mt-1 border border-border-color_1 overflow-hidden  fx-rounded">
          ...
          <Link href={""}>
            <li className="w-full p-3 fx-flex-between-ic gap-3 border-b border-border-color_1 text-text-color_2 hover:text-(--foreground)  hover:bg-background-color_800C">
          ...
          <Link href={""}>
            <li className="w-full p-3 fx-flex-between-ic gap-3 text-text-color_2 hover:text-(--foreground)  hover:bg-background-color_800C">
              <div className="fx-flex-cl gap-2">
                <CodeIcon />
