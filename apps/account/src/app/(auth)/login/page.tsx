...
export default function LoginPage() {
  ...
  return (
      ...
      <div className=" w-full">
        <h1 className="text-[25px] font-medium text-center mb-5 black-white-gradient-bt">
          Login to Fluctux
        </h1>
        ...
        <>
          ...
          <div className="flex justify-between items-center gap-3 mb-2 mt-4">
            ...
            <Link href={"/"} >
              <Label className="text-text-color_1 hover:!text-text-color_4 transition-colors !cursor-pointer ">Forget Password?</Label>
            </Link>
          </div>
          <FxInput
        ...
        <p className="text-text-color_2 text-[14px] mt-8">
          ...
          <Link href={""} className="text-text-color_1 hover:!text-text-color_4 transition-colors">
            Terms of Service
          </Link>{" "}
          and{" "}
          <Link href={""} className="text-text-color_1 hover:!text-text-color_4 transition-colors">
