...
import { type LucideIcon, Monitor, Moon, SunMedium } from "lucide-react";
...
export const ThemeToggler = () => {
  ...
  return (
    <div className="fx-flex-center w-fit rounded-full border border-border-color_1 p-[2px]">
        ...
        {THEME_ICONS.map((item, i) => {
          ...
          return (
            <li
              ...
              key={i}
              className={`z-1 cursor-pointer group rounded-full shrink-0 w-[30px] h-[30px]  fx-flex-center   ${activeIndex === i ? " text-text-color_1" : "text-text-icon_default"} `}
            >
              <Icon
                size={18}
