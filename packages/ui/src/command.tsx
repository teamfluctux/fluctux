...
>(({ className, ...props }, ref) => (
  <div className="flex items-center border-b border-border-color_1 px-2" cmdk-input-wrapper="">
    <Search className="mr-2 h-4 w-4 shrink-0 opacity-50" />
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "flex h-9 w-full rounded-md bg-transparent py-0 text-sm outline-none placeholder:text-text-color_3 disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      {...props}
    />
