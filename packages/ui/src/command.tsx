...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      "flex h-full w-full flex-col  outline-hidden! ring-0! bg-popover text-popover-foreground",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    className="flex items-center border-b border-border-color_1 px-2"
    cmdk-input-wrapper=""
  >
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "flex h-9 w-full rounded-md bg-transparent py-0 text-sm outline-hidden placeholder:text-text-color_3 disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      {...props}
    />
