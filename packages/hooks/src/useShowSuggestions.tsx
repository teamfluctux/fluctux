...
export const useShowSuggestions = ({ data }: UseShowSuggestionsPropsType) => {
  const [inputValue, setInputValue] = useState("");
  const [filteredSuggestions, setFilteredSuggestions] = useState<string[] | []>(
    []
  );
  const { isOpen: showSuggestions, setOpen: setShowSuggestions } =
    useToggleOpen({ id: "category-suggestions" });
