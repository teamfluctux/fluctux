...
export const DUMMY_ROW_DATA: Omit<ProductManageDataType, "variations" | "attributes">[] = [
  {
    id: "prod_a1b2c3",
    ...
    categories: [
      { label: "Electronics", value: "electronics", icon: MonitorIcon, slug: "electronics", isPrimary: true },
      { label: "Shopping", value: "shopping", icon: ShoppingBagIcon, slug: "shopping" },
    ],
    created_by: "admin",
  ...
  },
  {
    ...
    stock_status: "IN_STOCK",
    categories: [
      { label: "Clothing", value: "clothing", icon: ShirtIcon, slug: "clothing", isPrimary: true },
      { label: "Shopping", value: "shopping", icon: ShoppingBagIcon, slug: "shopping" },
    ],
    created_by: "john_doe",
  ...
  },
  {
    ...
    stock_status: "IN_STOCK",
    categories: [
      { label: "Home", value: "home", icon: HomeIcon, slug: "home", isPrimary: true },
  ...
  },
  {
    ...
    stock_status: "IN_STOCK",
    categories: [
      { label: "Sports", value: "sports", icon: DumbbellIcon, slug: "sports", isPrimary: true },
  ...
  },
  {
    ...
    stock_status: "IN_STOCK",
    categories: [
      { label: "Shopping", value: "shopping", icon: ShoppingBagIcon, slug: "shopping", isPrimary: true },
      { label: "Clothing", value: "clothing", icon: ShirtIcon, slug: "clothing" },
    ],
    created_by: "john_doe",
  ...
  },
  {
    ...
    stock_status: "IN_STOCK",
    categories: [
      { label: "Food", value: "food", icon: UtensilsIcon, slug: "food", isPrimary: true },
      { label: "Health", value: "health", icon: HeartIcon, slug: "health" },
    ],
    created_by: "jane_smith",
  ...
  },
  {
    ...
    categories: [
      { label: "Sports", value: "sports", icon: DumbbellIcon, slug: "sports", isPrimary: true },
      { label: "Automotive", value: "automotive", icon: CarIcon, slug: "automotive" },
    ],
    created_by: "admin",
  ...
  },
  {
    ...
    stock_status: "IN_STOCK",
    categories: [
      { label: "Health", value: "health", icon: HeartIcon, slug: "health", isPrimary: true },
      { label: "Shopping", value: "shopping", icon: ShoppingBagIcon, slug: "shopping" },
    ],
    created_by: "admin",
  ...
  },
  {
    ...
    stock_status: "IN_STOCK",
    categories: [
      { label: "Travel", value: "travel", icon: GlobeIcon, slug: "travel", isPrimary: true },
      { label: "Sports", value: "sports", icon: DumbbellIcon, slug: "sports" },
    ],
    created_by: "jane_smith",
  ...
  },
  {
    ...
    stock_status: "IN_STOCK",
    categories: [
      { label: "Books", value: "books", icon: BookIcon, slug: "books", isPrimary: true },
      { label: "Electronics", value: "electronics", icon: MonitorIcon, slug: "electronics" },
    ],
    created_by: "john_doe",
  ...
  },
  {
    ...
    stock_status: "IN_STOCK",
    categories: [
      { label: "Automotive", value: "automotive", icon: CarIcon, slug: "automotive", isPrimary: true },
      { label: "Electronics", value: "electronics", icon: MonitorIcon, slug: "electronics" },
    ],
    created_by: "jane_smith",
