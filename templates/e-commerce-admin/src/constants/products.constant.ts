...
export const DUMMY_PRODUCT_CATEGORIES = [
  ...
  { label: "Sunglasses & Eyewear", value: "sunglasses-eyewear" },
  { label: "Health & Wellness", value: "health-wellness" },
  { label: "Vitamins & Supplements", value: "vitamins-supplements" },
  { label: "Skincare", value: "skincare" },
  { label: "Haircare", value: "haircare" },
  { label: "Fragrances & Perfumes", value: "fragrances-perfumes" },
  { label: "Cleaning Supplies", value: "cleaning-supplies" },
  { label: "Storage & Organization", value: "storage-organization" },
  { label: "Flooring & Rugs", value: "flooring-rugs" },
  { label: "Wall Art & Decor", value: "wall-art-decor" },
  { label: "Candles & Home Fragrance", value: "candles-home-fragrance" },
